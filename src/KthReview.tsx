  ...
  return (
    <>
      <header className="hdr">
        <h2 className="view-title">第 k 小值复核</h2>
        <p className="sub">
          纯本地运算（Wavelet Matrix），不调用任何业务后端或在线服务。
          JSON 含 <code>readings</code>（0..65535 整数，1..200000 条）与{' '}
          <code>queries</code>（start/end/k，半开区间 [start,end)，至多 100000 条）。
        </p>
      </header>
